# 🛡️ Nuclear Armored Vehicle: Lab Infrastructure & Automation
...
> **Note :** Pour les IPs dynamiques, une migration vers une réservation via adresse MAC (sur OpenWrt/OPNsense) est recommandée pour une gestion centralisée.
...
## 🔐 3. Gestion des Inventaires (Ansible)
